        ...
        <div className="border-b border-gray-800 pb-12 mb-12">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6 md:mt-0">
              <a 
                href="#get-started" 
                className="bg-gray-800 flex items-center justify-center group text-center rounded-md" 
                style={{
                  padding: '12px 24px',
                }}
              >
              ...
              <a 
                href="#docs" 
                className="bg-transparent flex items-center justify-center group text-center border border-gray-600 rounded-md" 
                style={{
                  padding: '12px 24px',
                }}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <div className="border border-gray-700 rounded-lg p-5">
              ...
              <a href="#" className="inline-flex items-center text-sm text-gray-300 hover:text-white">
                Contact Support
          ...
          <div className="flex items-center">
            <div className="relative mr-2">
              <input 
                ...
                className="bg-gray-800 border border-gray-700 text-gray-300 py-2 pl-4 pr-10 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-gray-600 w-56"
              />
