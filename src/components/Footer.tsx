        ...
        <div className="border-b border-gray-200 pb-12 mb-12">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-6 md:mt-0">
              <a 
                href="#get-started" 
                className="bg-gray-100 flex items-center justify-center group text-center rounded-md" 
                style={{
                  padding: '12px 24px',
                }}
              >
              ...
              <a 
                href="#docs" 
                className="bg-transparent flex items-center justify-center group text-center border border-gray-300 rounded-md" 
                style={{
                  padding: '12px 24px',
                }}
              >
          ...
          <div className="flex items-center">
            <div className="relative mr-2">
              <input 
                ...
                className="bg-gray-100 border border-gray-200 text-gray-700 py-2 pl-4 pr-10 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-gray-300 w-56"
              />
