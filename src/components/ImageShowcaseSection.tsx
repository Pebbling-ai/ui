...
const VideoCard = ({ thumbnail, title, description }: { thumbnail: string, title: string, description: string }) => (
  <Card className="overflow-hidden rounded-xl shadow-elegant h-full">
    <div className="relative">
      ...
      <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
        <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white/30 backdrop-blur-sm flex items-center justify-center hover:bg-white/50 transition-all cursor-pointer">
    ...
    <section className="w-full pt-0 pb-8 sm:pb-12 bg-white" id="showcase">
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="flex flex-col items-center justify-center mb-8">
          <Badge 
            variant="outline" 
            className="mb-4 sm:mb-6 bg-pulse-50/50 text-pulse-600 hover:bg-pulse-50 border-pulse-200 px-3 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm font-medium rounded-full animate-on-scroll"
          >
            Product Mockup
          </Badge>
          
          <div className="max-w-3xl mx-auto text-center animate-on-scroll">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-display leading-tight mb-4 sm:mb-8">
        ...
        <div className="mx-auto max-w-5xl animate-on-scroll">
          <Carousel className="mx-auto">
            <CarouselContent>
              <CarouselItem className="sm:basis-1/1 md:basis-1/2 lg:basis-1/3 animate-on-scroll">
                <VideoCard 
