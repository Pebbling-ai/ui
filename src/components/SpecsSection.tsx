...
import { ArrowUpRight, AtomIcon, Check, Brain } from "lucide-react";
...
const ProductCard = ({ 
  ...
  <div className="bg-white rounded-2xl shadow-elegant p-8 hover:shadow-elegant-hover transition-all duration-300">
